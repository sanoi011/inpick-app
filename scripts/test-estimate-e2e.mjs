...
import { generateSyntheticFloorPlan } from '../src/lib/floor-plan/quantity/synthetic-floorplan.js';
import { adaptParsedFloorPlan } from '../src/lib/floor-plan/quantity/adapter.js';
import { calculateAllQuantities } from '../src/lib/floor-plan/quantity/quantity-calculator.js';
import { calculateEstimate } from '../src/lib/floor-plan/quantity/estimate-calculator.js';
