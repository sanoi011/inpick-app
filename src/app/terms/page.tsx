  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] text-[#0d0d0d]">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        <p className="text-[11px] font-semibold tracking-[0.16em] text-black/38">LEGAL</p>
        <h1 className="mb-8 mt-2 text-[32px] font-medium tracking-[-0.055em] sm:text-[40px]">서비스 이용약관</h1>
