...
function getMockMaterials(budget: string): AIMaterial[] {
  ...
  return [
    ...
    { categoryCode: "KITCHEN_SINK", category: "주방싱크", materialName: "인조대리석 싱크대", brand: "맞춤형", specification: "인조대리석 상판 + 2볼", unitPrice: Math.round(350000 * mult), laborPrice: 80000, unit: "EA", priceGrade: grade, reason: "현장 치수 맞춤 제작 기본값" },
    { categoryCode: "KITCHEN_CABINET", category: "주방수납장", materialName: "래핑 수납장", brand: "맞춤형", specification: "상/하부장 래핑 중급", unitPrice: Math.round(400000 * mult), laborPrice: 100000, unit: "m", priceGrade: grade, reason: "현장 치수 맞춤 제작 기본값" },
