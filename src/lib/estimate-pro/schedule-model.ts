...
// 시공 순서대로 정의 (주택 + 상가 공종 통합)
const PHASE_DEFS: PhaseDef[] = [
  { key: 'prep',  name: '가설·보양',            trades: ['가설'], color: '#94a3b8', minDays: 1 },
  { key: 'demo',  name: '철거·폐기물',          trades: ['철거'], color: '#ef4444', minDays: 2 },
  { key: 'win',   name: '샷시·창호·중문',       trades: ['샷시', '창호/문', '중문'], color: '#6366f1', minDays: 1 },
  { key: 'mep',   name: '설비·전기·공조 배관배선', trades: ['기계설비(배관)', '전기', '냉난방공사', '환기·후드공사', '네트워크·통신공사'], color: '#06b6d4', minDays: 3 },
  { key: 'fire',  name: '소방',                 trades: ['소방공사'], color: '#dc2626', minDays: 1 },
  { key: 'frame', name: '조적·미장·단열·방수',  trades: ['조적', '미장', '단열', '방수'], color: '#0ea5e9', minDays: 2 },
  { key: 'tile',  name: '타일',                 trades: ['타일'], color: '#14b8a6', minDays: 2 },
  { key: 'wood',  name: '목공·천장',            trades: ['목공', '천장'], color: '#f59e0b', minDays: 3 },
  { key: 'paint', name: '필름·도배·도장',       trades: ['필름', '도배/페인트'], color: '#a855f7', minDays: 2 },
  { key: 'floor', name: '바닥재·걸레받이',      trades: ['바닥재', '걸레받이/몰딩'], color: '#d97706', minDays: 1 },
  { key: 'inst',  name: '주방·위생·조명·설치',  trades: ['고정설비', '위생도기', '조명', '잡철/하드웨어', '상업주방'], color: '#ec4899', minDays: 2 },
  { key: 'sign',  name: '간판·사인',            trades: ['간판·파사드공사'], color: '#8b5cf6', minDays: 1 },
  { key: 'clean', name: '준공청소·검수',        trades: ['정리/청소'], color: '#64748b', minDays: 1 },
];
